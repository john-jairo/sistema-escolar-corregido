 ...
 <div class="app-sidebar__overlay" data-toggle="sidebar"></div>
    <aside class="app-sidebar">
      ...
      <li><a class="app-menu__item" href="lista_grados.php"><i class="app-menu__icon fas fa-graduation-cap"></i><span class="app-menu__label">Grados</span></a></li>
      ...
      <li><a class="app-menu__item" href="lista_materias.php"><i class="app-menu__icon fas fa-book"></i><span class="app-menu__label">Materias</span></a></li>
      <li><a class="app-menu__item" href="lista_periodos.php"><i class="app-menu__icon fas fa-calendar-alt"></i><span class="app-menu__label">Períodos</span></a></li>
      <li><a class="app-menu__item" href="lista_actividad.php"><i class="app-menu__icon fas fa-edit"></i><span class="app-menu__label">Actividades</span></a></li>
      <li><a class="app-menu__item" href="lista_profesor_materia.php"><i class="app-menu__icon fas fa-user-check"></i></i><span class="app-menu__label">Profesor Materia</span></a></li>
      <li><a class="app-menu__item" href="lista_alumno_profesor.php"><i class="app-menu__icon fas fa-user-friends"></i><span class="app-menu__label">Alumno Profesor</span></a></li>
