...
<aside class="app-sidebar">
  ...
  <ul class="app-menu">
    <li><a class="app-menu__item" href="index.php"><i class="app-menu__icon fas fa-home"></i><span class="pp-menu__label">Inicio</span></a></li>
    <li class="treeview">
    ...
    <li><a class="app-menu__item" href="../logout.php"><i class="app-menu__icon fas fa-sign-out-alt"></i><span class="pp-menu__label">Logout</span></a></li>
  </ul>
</aside>