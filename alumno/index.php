...
<main class="app-content">
  <div class="row">
    <div class="col-md-12 border shadow p-1 bg-info text-white">
      <h3 class="display-4">SISTEMA ESCOLAR - ACOINPREV</h3>
    </div>
  </div>
  <div class="row">
    <div class="col-md-12 text-center border mt-3 p-3 bg-light">
      <h4>Mis cursos</h4>
    </div>
  </div>
  <div class="row">
    ...
    ?>
        <div class="col-md-4 text-center border mt-3 p-4 bg-light">
          <div class="card m-2 shadow" style="width: 23 rem;">
            <img src="images/card-school.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              <h4 class="card-title text-center"><?= $data['nombre_materia'] ?></h4>
              <h5 class="carx-title"> Grado <kvd class="bg-info"><?= $data['nombre_grado'] ?></kvd> - Aula <kbd class="bg_info"><?= $data['nombre_aula'] ?></kbd></h5>
